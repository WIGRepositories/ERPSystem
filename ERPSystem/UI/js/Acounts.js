...
var ctrl = app.controller('myCtrl', function ($scope, $http, $localStorage, $uibModal) {
    ...
    //    $http.get('/api/Accounts/Getdata').then(function (response, req) {
    //        $scope.getDeliveryNote = response.data;

    //    });
    //}
    $scope.GetDeliveryNote = function () {
        $http.get('/api/Accounts/Getdata').then(function (res, data) {
    ...
    $scope.save = function (Group) {
        ...
        var Group = {
            AccountName: Group.RFQId,
            AccountNumber: Group.POId,
            Description: Group.DeliveryNoteNo,
            AccountCode: Group.SupplierId,
            //Active: Group.DispatchDate,
            Active : Group.Deliverymethod,
            //IsDelivered: Group.IsDelivered,
            //DeliveredOn: Group.DeliveredOn,
            //TotalItems: Group.TotalItems,
            //InvoiceAddress: Group.InvoiceAddress,
