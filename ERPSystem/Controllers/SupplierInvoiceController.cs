...
namespace ERPSystem.Controllers
{
    public class SupplierInvoiceController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/SupplierInvoice/SaveLocationsimport")]
        ...
        [HttpPost]
        [Route("api/SupplierInvoice/SaveLocationsimport1")]

        public DataTable PurchaseOrderController1(SupplierInvoice K)
        {
            DataTable dt = new DataTable();
            SqlConnection con = new SqlConnection();
