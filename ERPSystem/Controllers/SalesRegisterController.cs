...
{
    public class SalesRegisterController : ApiController
    {
         [HttpGet]
        [Route("api/SalesRegister/getdata")]
        public DataTable CustomerPurchase ()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "GetSalesRegister";
         ...
         [HttpPost]
         [Route("api/SalesRegister/savedetails")]
         public DataTable CustomerpurchaseOrder(SalesRegister A)
         {
             DataTable dt = new DataTable();
             ...
             try
             {
                 ...
                 cmd.Connection = con;
                 cmd.CommandType = CommandType.StoredProcedure;
                 cmd.CommandText = "InsUpdDelSalesRegister";
                 ...
                 SqlParameter rf = new SqlParameter("@SoldOn", SqlDbType.DateTime);
                 rf.Value = A.SoldOn;
