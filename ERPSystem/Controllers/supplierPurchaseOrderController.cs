...
{
    public class supplierPurchaseOrderController : ApiController
    {
        [HttpGet]
        [Route("api/supplierPurchaseOrder/getdata")]
        public DataTable SuplierPurchase()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "GetsupplierPurchaseOrder";
        ...
        [HttpPost]
        [Route("api/supplierPurchaseOrder/savedetails")]
        public DataTable SupplierPurchaseOrder(supplierPurchaseOrder A)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "InsUpdDelsupplierPurchaseOrder";
                ...
                SqlParameter act = new SqlParameter("@ShippingMethod", SqlDbType.Int);
                act.Value = A.ShippingMethod;
